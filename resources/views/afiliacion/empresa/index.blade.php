                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <input type="text" class="form-control" name="editar_ruc" id="editar_ruc" required placeholder="">
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-4 col-sm-3 label-align">Departamento</label>
                            <div class="col-md-12 col-sm-12 ">
                                <input type="text" class="form-control" name="editar_departamento" id="editar_departamento" required placeholder="">
                            </div>
                        </div>
                        <div class="item form-group">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-4 col-sm-3 label-align">RUC</label>
                            <div class="col-md-12 col-sm-12 ">
                                <input type="text" class="form-control" name="ruc" id="ruc" required placeholder="">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-4 col-sm-3 label-align">Direccción</label>
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-4 col-sm-3 label-align">Departamento</label>
                            <div class="col-md-12 col-sm-12 ">
                                <input type="text" class="form-control" name="departamento" id="departamento" required placeholder="">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-4 col-sm-3 label-align">Representante</label>

...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Generar Informes Contables</div>
                <div class="card-body">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" id="reporteDiarioTab" data-toggle="tab" href="#reporteDiario">Reporte Contable Diario</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="reporteMensualTab" data-toggle="tab" href="#reporteMensual">Reporte Contable Mensual</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="reporteAnualTab" data-toggle="tab" href="#reporteAnual">Reporte Contable Anual</a>
                        </li>
                    </ul>
                    <div class="tab-content mt-4">
                        <div class="tab-pane fade show active" id="reporteDiario">
                            <h5>Reporte Diario</h5>
                            <form action="{{ route('reporte-contable-diario') }}" method="POST">
                                @csrf
                        ...
                        <div class="tab-pane fade" id="reporteMensual">
                            ...
                            <form action="{{ route('reporte-contable-mensual') }}" method="POST">
                                @csrf
                        ...
                        <div class="tab-pane fade" id="reporteAnual">
                            ...
                            <form action="{{ route('reporte-contable-anual') }}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label for="anioMensual">Año:</label>
                                    <input type="number" name="anioMensual" id="anioMensual" class="form-control" min="1900" max="{{ date('Y') }}" required>
